...
entity gen_adder4_shadow_windowed is
    generic (
    ...
    port (
        ...
        copy_rnd    : in  natural;
        clamp_en    : in  std_logic_vector(21 downto 0);
        clamp_value : in  std_logic_vector(21 downto 0);
        spins       : out std_logic_vector(21 downto 0)
    );
end entity;

architecture rtl of gen_adder4_shadow_windowed is
    constant NODE_COUNT : natural := 22;
    signal spin_s      : std_logic_vector(21 downto 0) := (others => '0');
    signal node_enable : std_logic_vector(21 downto 0) := (others => '0');
    signal phase       : natural range 0 to 21 := 0;
    signal sched_state : std_logic_vector(31 downto 0) := x"EF165754";
...
begin
    ...
    process (all)
        variable enables_v  : std_logic_vector(21 downto 0);
        variable selected_v : natural range 0 to 21;
    ...
    begin
        ...
        if enable = '1' then
            ...
            for offset in 0 to NODE_COUNT - 1 loop
                ...
                if selected_v = 12 then selected_en_v := block_en0; end if;
                if selected_v = 13 then selected_en_v := block_en1; end if;
                if selected_v = 14 then selected_en_v := block_en2; end if;
                if selected_v = 15 then selected_en_v := block_en3; end if;
                if selected_v = 16 then selected_en_v := write_en1; end if;
                if selected_v = 17 then selected_en_v := write_en2; end if;
                if selected_v = 18 then selected_en_v := write_en3; end if;
                if selected_v = 19 then selected_en_v := xfer_en1; end if;
                if selected_v = 20 then selected_en_v := xfer_en2; end if;
                if selected_v = 21 then selected_en_v := xfer_en3; end if;
    ...
    neighbors_1 <= (0 => spin_s(5), 1 => spin_s(9), 2 => spin_s(13), 3 => spin_s(19), others => '0');
    neighbors_2 <= (0 => spin_s(6), 1 => spin_s(10), 2 => spin_s(14), 3 => spin_s(20), others => '0');
    neighbors_3 <= (0 => spin_s(7), 1 => spin_s(11), 2 => spin_s(15), 3 => spin_s(21), others => '0');
    neighbors_4 <= (0 => spin_s(0), 1 => spin_s(8), 2 => spin_s(12), others => '0');
    neighbors_5 <= (0 => spin_s(1), 1 => spin_s(9), 2 => spin_s(13), 3 => spin_s(19), others => '0');
    neighbors_6 <= (0 => spin_s(2), 1 => spin_s(10), 2 => spin_s(14), 3 => spin_s(20), others => '0');
    neighbors_7 <= (0 => spin_s(3), 1 => spin_s(11), 2 => spin_s(15), 3 => spin_s(21), others => '0');
    neighbors_8 <= (0 => spin_s(0), 1 => spin_s(4), 2 => spin_s(12), others => '0');
    neighbors_9 <= (0 => spin_s(1), 1 => spin_s(5), 2 => spin_s(13), 3 => spin_s(19), others => '0');
    neighbors_10 <= (0 => spin_s(2), 1 => spin_s(6), 2 => spin_s(14), 3 => spin_s(20), others => '0');
    neighbors_11 <= (0 => spin_s(3), 1 => spin_s(7), 2 => spin_s(15), 3 => spin_s(21), others => '0');
    neighbors_12 <= (0 => spin_s(0), 1 => spin_s(4), 2 => spin_s(8), others => '0');
    neighbors_13 <= (0 => spin_s(1), 1 => spin_s(5), 2 => spin_s(9), 3 => spin_s(19), others => '0');
    neighbors_14 <= (0 => spin_s(2), 1 => spin_s(6), 2 => spin_s(10), 3 => spin_s(20), others => '0');
    neighbors_15 <= (0 => spin_s(3), 1 => spin_s(7), 2 => spin_s(11), 3 => spin_s(21), others => '0');
    neighbors_16 <= (0 => spin_s(12), others => '0');
    neighbors_17 <= (0 => spin_s(13), others => '0');
    neighbors_18 <= (0 => spin_s(14), others => '0');
    neighbors_19 <= (0 => spin_s(16), others => '0');
    neighbors_20 <= (0 => spin_s(17), others => '0');
    neighbors_21 <= (0 => spin_s(18), others => '0');
