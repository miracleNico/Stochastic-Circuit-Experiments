...
entity gen_adder4_shadow1_windowed is
    generic (
...
architecture rtl of gen_adder4_shadow1_windowed is
    ...
    signal sched_state : std_logic_vector(31 downto 0) := x"048A47A7";
...
begin
    ...
    begin
        ...
        if enable = '1' then
            ...
            for offset in 0 to NODE_COUNT - 1 loop
                ...
                if selected_v = 4 then selected_en_v := block_en0; end if;
                if selected_v = 5 then selected_en_v := block_en1; end if;
                if selected_v = 6 then selected_en_v := block_en2; end if;
                if selected_v = 7 then selected_en_v := block_en3; end if;
                ...
                if selected_v = 16 then selected_en_v := copy_en1; end if;
                if selected_v = 17 then selected_en_v := copy_en2; end if;
                if selected_v = 18 then selected_en_v := copy_en3; end if;
    ...
    neighbors_13 <= (0 => spin_s(1), 1 => spin_s(5), 2 => spin_s(9), 3 => spin_s(16), others => '0');
    neighbors_14 <= (0 => spin_s(2), 1 => spin_s(6), 2 => spin_s(10), 3 => spin_s(17), others => '0');
