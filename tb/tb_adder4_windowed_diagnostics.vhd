...
entity tb_adder4_windowed_diagnostics is
    generic (
        ACTIVE_RND_WEIGHT : natural := 1;
        FINAL_RND_WEIGHT  : natural := 1;
        WAVE0_CYCLES      : natural := 192;
        WAVE1_CYCLES      : natural := 192;
        WAVE2_CYCLES      : natural := 192;
        WAVE3_CYCLES      : natural := 192;
        FINAL_CYCLES      : natural := 0;
        COUNT_CYCLES      : natural := 100
    );
end entity;

architecture sim of tb_adder4_windowed_diagnostics is
...
begin
    ...
    stimulus : process
        ...
        begin
            ...
            report "window4 forward " & integer'image(aval) & "+" & integer'image(bval) &
                   ...
                   " final_rnd=" & integer'image(FINAL_RND_WEIGHT) &
    ...
    begin
        ...
        check_forward(14, 1);
        check_forward(15, 1);
        report "tb_adder4_windowed_diagnostics completed" severity note;
        wait;
    end process;
end architecture;
