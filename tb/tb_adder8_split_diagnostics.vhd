...
entity tb_adder8_split_diagnostics is
    generic (
...
architecture sim of tb_adder8_split_diagnostics is
...
begin
    ...
    dut : entity work.gen_adder8_split_q8_opt
    ...
    stimulus : process
        ...
        begin
            ...
            report "split diagnostic forward " & integer'image(aval) & "+" & integer'image(bval) &
    ...
    begin
        ...
        report "tb_adder8_split_diagnostics completed" severity note;
        wait;
    end process;
end architecture;
