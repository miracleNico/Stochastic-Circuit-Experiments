...
entity tb_e4m3_block_timing is
    generic (
...
architecture sim of tb_e4m3_block_timing is
...
begin
    ...
    ha_dut : entity work.gen_xor_gate_fp8_e4m3_opt
    ...
    fa_dut : entity work.gen_fa_gate_fp8_e4m3_opt
        generic map (RND_WEIGHT => RND_WEIGHT)
        port map (
            clk         => clk,
            rst         => rst_fa,
    ...
    stimulus : process
        ...
        begin
            ...
            report "block_timing HA " & integer'image(aval) & "+" & integer'image(bval) &
        ...
        begin
            ...
            report "block_timing FA " & integer'image(aval) & "+" & integer'image(bval) &
    ...
    begin
        ...
        report "tb_e4m3_block_timing completed" severity note;
        wait;
    end process;
end architecture;
