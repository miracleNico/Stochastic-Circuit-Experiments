...
entity tb_adder4_shadow1_diagnostics is
    generic (
        ...
        BLOCK3_CYCLES    : natural := 12;
        COPY_CYCLES      : natural := 8;
        COUNT_CYCLES     : natural := 100
    );
end entity;

architecture sim of tb_adder4_shadow1_diagnostics is
...
begin
    ...
    stimulus : process
        ...
        begin
            ...
            report "shadow1 forward " & integer'image(aval) & "+" & integer'image(bval) &
            ...
            for bit in 1 to 3 loop
                report "  q" & integer'image(bit) &
                       "_carry_match=" & integer'image(shadow_hits(bit)) &
    ...
    begin
        ...
        check_forward(14, 1);
        check_forward(15, 1);
        report "tb_adder4_shadow1_diagnostics completed" severity note;
        wait;
    end process;
end architecture;
