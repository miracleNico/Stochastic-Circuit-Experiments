...
if {[file exists work_adder4_shadow_diag]} {
    vdel -lib work_adder4_shadow_diag -all
}
...
vlib work_adder4_shadow_diag
vmap work work_adder4_shadow_diag

vcom -2008 ../src/inv_sc_pkg.vhd
vcom -2008 ../src/lfsr32.vhd
vcom -2008 ../src/spin_node.vhd
vcom -2008 ../src/generated_shadow_adder4.vhd
vcom -2008 ../tb/tb_adder4_shadow_diagnostics.vhd
...
vsim \
    ...
    work.tb_adder4_shadow_diagnostics

set case_count 16
set settle_cycles [expr {$block0_cycles + $block1_cycles + $block2_cycles + $block3_cycles + (6 * $copy_cycles)}]
