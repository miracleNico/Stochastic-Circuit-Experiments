...
if {[file exists work_adder4_shadow1_diag]} {
    vdel -lib work_adder4_shadow1_diag -all
}
...
vlib work_adder4_shadow1_diag
vmap work work_adder4_shadow1_diag

vcom -2008 ../src/inv_sc_pkg.vhd
vcom -2008 ../src/lfsr32.vhd
vcom -2008 ../src/spin_node.vhd
vcom -2008 ../src/generated_shadow1_adder4.vhd
vcom -2008 ../tb/tb_adder4_shadow1_diagnostics.vhd
...
vsim \
    ...
    work.tb_adder4_shadow1_diagnostics
