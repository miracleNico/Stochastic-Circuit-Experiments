...
if {[file exists work_adder4_shadow1_exhaustive]} {
    vdel -lib work_adder4_shadow1_exhaustive -all
}
...
vlib work_adder4_shadow1_exhaustive
vmap work work_adder4_shadow1_exhaustive
