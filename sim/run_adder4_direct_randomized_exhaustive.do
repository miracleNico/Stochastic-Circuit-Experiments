...
if {[file exists work_adder4_direct_random_exhaustive]} {
    vdel -lib work_adder4_direct_random_exhaustive -all
}
...
vlib work_adder4_direct_random_exhaustive
vmap work work_adder4_direct_random_exhaustive

vcom -2008 ../src/inv_sc_pkg.vhd
vcom -2008 ../src/lfsr32.vhd
vcom -2008 ../src/spin_node.vhd
vcom -2008 $generated_networks
vcom -2008 ../tb/tb_adder4_direct_randomized_exhaustive.vhd
...
vsim \
    ...
    -gTRIALS=$trials \
    work.tb_adder4_direct_randomized_exhaustive
