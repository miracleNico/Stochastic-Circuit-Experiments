...
if {[file exists work_adder4_shadow1_q34_inverse]} {
    vdel -lib work_adder4_shadow1_q34_inverse -all
}
...
vlib work_adder4_shadow1_q34_inverse
vmap work work_adder4_shadow1_q34_inverse
...
vcom -2008 ../tb/tb_adder4_shadow1_inverse.vhd
...
vsim \
    ...
    work.tb_adder4_shadow1_inverse

set bsum_cases 256
set sum_cases 31
set case_count [expr {$bsum_cases + $sum_cases}]
