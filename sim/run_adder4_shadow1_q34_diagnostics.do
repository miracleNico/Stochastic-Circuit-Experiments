...
if {[file exists work_adder4_shadow1_q34_diag]} {
    vdel -lib work_adder4_shadow1_q34_diag -all
}
...
vlib work_adder4_shadow1_q34_diag
vmap work work_adder4_shadow1_q34_diag
