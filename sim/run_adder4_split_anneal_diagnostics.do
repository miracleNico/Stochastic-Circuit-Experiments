...
if {[file exists work_adder4_split_anneal_diag]} {
    vdel -lib work_adder4_split_anneal_diag -all
}

set generated_networks "../src/generated_annealed_split_adder4.vhd"
if {[info exists ::env(GENERATED_NETWORKS_VHDL)]} {
    set generated_networks $::env(GENERATED_NETWORKS_VHDL)
}
set hot_rnd_weight 114688
...
vlib work_adder4_split_anneal_diag
vmap work work_adder4_split_anneal_diag

vcom -2008 ../src/inv_sc_pkg.vhd
vcom -2008 ../src/lfsr32.vhd
vcom -2008 ../src/spin_node.vhd
vcom -2008 $generated_networks
vcom -2008 ../tb/tb_adder4_split_anneal_diagnostics.vhd
...
vsim \
    ...
    work.tb_adder4_split_anneal_diagnostics
