...
if {[file exists work_adder_split_diag]} {
...
vlib work_adder_split_diag
vmap work work_adder_split_diag

vcom -2008 ../src/inv_sc_pkg.vhd
vcom -2008 ../src/lfsr32.vhd
vcom -2008 ../src/spin_node.vhd
vcom -2008 $generated_networks
vcom -2008 ../tb/tb_adder8_split_diagnostics.vhd

vsim -gADDER_RND_WEIGHT=$adder_rnd_weight -gSETTLE_CYCLES=$settle_cycles -gCOUNT_CYCLES=$count_cycles work.tb_adder8_split_diagnostics
run 500 us
